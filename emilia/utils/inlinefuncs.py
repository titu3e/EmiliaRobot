...
async def alive_function(answers):
    ...
    msg = f"""
**[Emilia Robot ❤️](https://t.me/EmiliaPrjkt_bot):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [OWNER BOT](t.me/ZenitsuPrjkt)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
            description="Check Bot's Stats",
            thumb_url="https://telegra.ph/file/8142e7aac030eebd40a4e.jpg",
            input_message_content=InputTextMessageContent(
