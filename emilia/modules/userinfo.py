...
from emilia.modules.sql.afk_sql import is_afk, check_afk_status
...
from emilia import telethn as YoneTelethonClient, TIGERS, DRAGONS, DEMONS
...
def stats(update: Update, context: CallbackContext):
    stats = "<b>┎─⌈ Current Emilia stats ⌋</b>\n" + "\n".join([mod.__stats__() for mod in STATS])
